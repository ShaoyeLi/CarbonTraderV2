...
import deployments from "../Foundry-CarbonTrade/deployments/latest.json";
...
const DEPLOY = deployments as DeploymentJson;

export const DEFAULT_CONFIG = {
  carbonAddr: DEPLOY.CarbonTrader || "",
  tokenAddr: DEPLOY.USDT || "",
  saleAddr: DEPLOY.TokenSale || "",
  faucetAddr: DEPLOY.TokenFaucet || ""
};
